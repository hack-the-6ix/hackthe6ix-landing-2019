...
export const TIMEZONES = [
  ...
  '(GMT -10:00) Hawaii',
  '(GMT -9:00) Alaska',
  '(GMT -8:00) Pacific Time (US & Canada), Los Angeles, Vancouver',
  '(GMT -7:00) Mountain Time (US & Canada), Edmonton, Denver',
  '(GMT -6:00) Central Time (US & Canada), Mexico City, Chicago',
  '(GMT -5:00) Eastern Time (US & Canada), Toronto, New York',
