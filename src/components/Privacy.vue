<template>
  <div class="privacy">
    ...
    <h4>Notice: Our privacy policy differs from the MLH Privacy Policy.</h4>
    ...
    <p>We may provide Users personal identification information to the sponsors of our event. We may also share generic aggregated demographic information not linked to any personal identification information regarding visitors and users with our business partners, trusted affiliates and advertisers for the purposes outlined above.</p>
    ...
    <p>This document was last updated on August 20, 2018.</p>
    </div>
  </div>
</template>
