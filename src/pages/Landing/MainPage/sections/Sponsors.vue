<template>
  <Container
    ...
    block="sponsor"
    as="section"
    :class="{'sponsor--show': animate}"
  >
    <h2 class="sponsor__title">Sponsors</h2>
    <h3 class="sponsor__subtitle">
      Our amazing sponsors who make Hack the 6ix possible
    </h3>
    <ul
      class="sponsor__items"
    ...
    >
      ...
      >
        ...
        <a :href="sponsor.sublink"
          ><h3 style="margin:0;" class="sponsor__text">
            {{ sponsor.subtext }}
          </h3></a
        >
      </li>
    ...
    <div class="sponsor__footer">
      <h3 class="sponsor__subtitle sponsor__subtitle--center">
        Interested in being a sponsor?
      </h3>
      <p class="sponsor__text">
        Please send us a business inquiry at
        <a href="mailto:sponsors@hackthe6ix.com">sponsors@hackthe6ix.com</a>
      </p>
    </div>
