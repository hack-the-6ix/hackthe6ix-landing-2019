        ...
        <div class="user__buttons">
          <div class="user__buttons-row">
            <Button
              path="/apply"
              :click="navigate"
              class="user__button user__button--col"
              disabled
          ...
          <Button
            :click="logout"
            icon="sign-out-alt"
            class="user__button user__button--logout"
            secondary
            >Logout</Button
          >
        </div>
...
export default {
  ...
  data() {
    return {
      user: {
        image:
          'https://steamuserimages-a.akamaihd.net/ugc/102852399388817485/D8DA2E6ABE1B8CD7A9B2EA849FBA0C5CB99CE2B9/',
        firstname: 'Firstname',
        lastname: 'Lastname',
      },
    };
